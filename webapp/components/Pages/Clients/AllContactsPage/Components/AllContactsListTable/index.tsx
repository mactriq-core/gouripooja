...
const TableMetaKey = "@Clients-Contacts-ContactsListTable";
...
const mockData = [
  {
    ContactName: "Test Contact 01",
    AccountType: "Retail",
    Name: "Contact A",
    createdAt: "20 June 2023",
  },
  {
    ContactName: "Test Contact 02",
    AccountType: "Export",
    Name: "Contact B",
    ...
    >
      <Box className="flex sm:flex-col-reverse items-center sm:items-start justify-between gap-[1.25rem]">
        ...
        <Button
          ...
          startIcon={<Add />}
          onClick={() => {
            toast.success("Button Clicked : Create Contact ");
          }}
        >
          Create Contact
        </Button>
        ...
        <Table stickyHeader>
          ...
          <TableBody>
            {filteredData
              ...
              ?.map((row, i) => {
                const { ContactName, AccountType, Name, createdAt } = row;
                return (
                  <TableRow key={i}>
                    {columns?.map((column, i) => {
                      if (column.show) {
                        if (column.name === "Contact Name") {
                          return (
